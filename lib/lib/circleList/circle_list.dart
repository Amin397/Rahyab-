...
import 'package:rahyab/lib/circleList/radial_drag_gesture_detector.dart';

export 'package:rahyab/lib/circleList/radial_drag_gesture_detector.dart';
...
class _CircleListState extends State<CircleList>
  ...
  Offset start = new Offset(80.0, 100.0);
          ...
          Positioned(
            ...
            child: RadialDragGestureDetector(
              ...
              onRadialDragEnd: () {
                ...
                _controller = AnimationController(
                    vsync: this,
                    duration: widget?.animationSetting?.duration ?? Duration(seconds: 4));
                _animationRotate = Tween(begin: 0.0, end: 1.0).animate(CurvedAnimation(
                    parent: _controller,
                    curve: widget?.animationSetting?.curve ?? Curves.easeOutBack));
                _controller.addStatusListener((status) {
